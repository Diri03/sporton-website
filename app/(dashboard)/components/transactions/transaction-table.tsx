...
const transactionData = [
  {
    date: "25/02/2026 13:52",
    customer: "Tsubasa Oozora",
    contact: "+1233454323",
    total: 100000,
    status: "paid",
  },
  {
    date: "24/02/2026 21:12",
    customer: "Agus Sehat",
    contact: "+122999",
    total: 250000,
    status: "rejected",
        ...
        <tbody>
          {transactionData.map((data, index) => (
            ...
            >
              ...
              <td className="px-6 py-4 font-medium">
                <div
                  className={`px-4 py-1 rounded-full border text-center w-fit uppercase ${getStatusColor(data.status)}`}
                >
                  {data.status}
                </div>
              </td>
