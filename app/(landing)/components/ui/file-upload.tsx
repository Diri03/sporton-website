    ...
    >
      ...
      {!file ? (
        <div className="text-center my-5">
          <FiUploadCloud className="text-primary mx-auto text-2xl" />
        ...
        <div className="text-center">
          ...
          <button
            onClick={removeFile}
            className="flex gap-2 bg-primary/90 text-white mx-auto rounded mt-4 px-2 py-1 text-xs items-center"
          >
